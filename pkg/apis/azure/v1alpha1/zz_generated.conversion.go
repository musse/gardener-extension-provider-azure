...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*AzResourceReference)(nil), (*azure.AzResourceReference)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_AzResourceReference_To_azure_AzResourceReference(a.(*AzResourceReference), b.(*azure.AzResourceReference), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*azure.AzResourceReference)(nil), (*AzResourceReference)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_azure_AzResourceReference_To_v1alpha1_AzResourceReference(a.(*azure.AzResourceReference), b.(*AzResourceReference), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_AzResourceReference_To_azure_AzResourceReference(in *AzResourceReference, out *azure.AzResourceReference, s conversion.Scope) error {
	out.Name = in.Name
	out.ResourceGroup = in.ResourceGroup
	return nil
}

// Convert_v1alpha1_AzResourceReference_To_azure_AzResourceReference is an autogenerated conversion function.
func Convert_v1alpha1_AzResourceReference_To_azure_AzResourceReference(in *AzResourceReference, out *azure.AzResourceReference, s conversion.Scope) error {
	return autoConvert_v1alpha1_AzResourceReference_To_azure_AzResourceReference(in, out, s)
}

func autoConvert_azure_AzResourceReference_To_v1alpha1_AzResourceReference(in *azure.AzResourceReference, out *AzResourceReference, s conversion.Scope) error {
	out.Name = in.Name
	out.ResourceGroup = in.ResourceGroup
	return nil
}

// Convert_azure_AzResourceReference_To_v1alpha1_AzResourceReference is an autogenerated conversion function.
func Convert_azure_AzResourceReference_To_v1alpha1_AzResourceReference(in *azure.AzResourceReference, out *AzResourceReference, s conversion.Scope) error {
	return autoConvert_azure_AzResourceReference_To_v1alpha1_AzResourceReference(in, out, s)
}
...
func autoConvert_v1alpha1_NatGatewayConfig_To_azure_NatGatewayConfig(in *NatGatewayConfig, out *azure.NatGatewayConfig, s conversion.Scope) error {
	...
	out.IPAddresses = *(*[]azure.AzResourceReference)(unsafe.Pointer(&in.IPAddresses))
	out.IPAddressRanges = *(*[]azure.AzResourceReference)(unsafe.Pointer(&in.IPAddressRanges))
	return nil
}
...
func autoConvert_azure_NatGatewayConfig_To_v1alpha1_NatGatewayConfig(in *azure.NatGatewayConfig, out *NatGatewayConfig, s conversion.Scope) error {
	out.Enabled = in.Enabled
	out.IPAddresses = *(*[]AzResourceReference)(unsafe.Pointer(&in.IPAddresses))
	out.IPAddressRanges = *(*[]AzResourceReference)(unsafe.Pointer(&in.IPAddressRanges))
	return nil
}
